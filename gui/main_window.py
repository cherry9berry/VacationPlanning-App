...
class MainWindow:
    ...
    def insert_instructions(self):
        ...
        instructions_text = """
1. СОЗДАНИЕ ФАЙЛОВ ОТПУСКОВ:
   - Подготовьте Excel файл с данными сотрудников.
   - Укажите файл и целевую папку.
   - Создайте файлы, нажав кнопку.

2. РАБОТА С ОТЧЕТАМИ:
   - Выберите целевую папку.
   - Создайте отчет по отделам, нажав кнопку в соответствующем разделе.
   - Создайте общий отчет, нажав кнопку в соответствующем разделе.

3. ВАЖНО:
   - Шаблоны (.xlsx) должны быть в папке 'templates/' рядом с программой.
   - Отчет по блоку может быть сформирован вызовом скрипта внутри папки блока.
   - Общий отчет формируется на основе отчетов по блокам.
"""
